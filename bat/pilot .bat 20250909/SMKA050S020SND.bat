...
SETLOCAL
REM ************************************
REM ** ジョブID　：SMKA050S020SND
REM ** ジョブ名　：住友化学_発注データ送信
REM ** 取引先名　：住友化学
REM ** カテゴリ名：発注
REM ** 引数　　　：なし
...
REM **    1.00 2025/04/30 FJ)松田 【R60795】新規作成
REM **
REM *********************************************************************************
...
SET JOBNAME=SMKA050S020SND
SET HULFT_FILE_ID=IKSMK006
REM 発注ファイル：SMKA0501CII
