...
SETLOCAL
REM ************************************
REM ** ジョブID　：NSBA140S020SND
REM ** ジョブ名　：日本触媒_支払・支払明細データ送信
REM ** 取引先名　：日本触媒
REM ** カテゴリ名：支払・支払明細
REM ** 引数　　　：なし
...
SET JOBNAME=NSBA140S020SND
SET HULFT_FILE_ID_PAY=IKNIS006
SET HULFT_FILE_ID_PAYDTL=IKNIS005
REM 支払ファイル：NSBA1501HCII
REM 支払明細ファイル：=NSBA1401HCII
...
REM %HULFT_PATH% -f %HULFT_FILE_ID_PAY% -sync
...
REM %HULFT_PATH% -f %HULFT_FILE_ID_PAYDTL% -sync
