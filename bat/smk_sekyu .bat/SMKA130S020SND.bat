...
SETLOCAL
REM ************************************
REM ** ジョブID　：SMKA130S020SND
REM ** ジョブ名　：住友化学_請求確認データ送信
REM ** 取引先名　：住友化学
REM ** カテゴリ名：請求確認
REM ** 引数　　　：なし
...
REM **    1.00 2025/06/24 FJ)HANI 【R60795】新規作成
REM **
REM *********************************************************************************
...
SET JOBNAME=SMKA130S020SND
SET HULFT_FILE_ID=IKSMK007
REM 請求確認ファイル：SMKA1301HCII
