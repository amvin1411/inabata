...
REM **    1.00 2025/07/07  FJ)HANI 【R60795】新規作成
REM **
REM *********************************************************************************
CALL .\jobenvset
...
SET JOBNAME=UBEA050C010
SET FILE_NAME=UBEA0501
SET FILE_NAME_C=UBEA0501CII
...
410trn.exe -S -HDR宇部興産.HDT -TBL宇部.tdt -NAME宇部興産（注文） -i -fn -C1510 -J101913000020 -A501015000020 %TEMP_PATH%\%FILE_NAME% %TEMP_PATH%\%FILE_NAME_C%
